    ...
    while webcam_status:
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                cls = int(box.cls[0])
                if cls == 0:  # Assuming class 0 corresponds to "buah matang"
                    counts_camera[0] += 1
                    color = (0, 255, 0)  # Hijau untuk buah matang
                elif cls == 1:  # Assuming class 1 corresponds to "buah mentah"
                    color = (0, 0, 255)  # Merah untuk buah mentah
                    counts_camera[1] += 1
...
def detect_objects_on_image(buf):
    ...
    try:
        ...
        for box in result.boxes:
            ...
            if class_id == 0:  # Assuming class 0 corresponds to "buah matang"
                counts_upload[0] += 1
            elif class_id == 1:  # Assuming class 1 corresponds to "buah mentah"
                counts_upload[1] += 1
        return output
    except Exception as e:
